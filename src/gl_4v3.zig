...
// generator /home/parada/builds/zig-opengl/bin/Debug/net6.0/generator.dll OpenGL-Registry/xml/gl.xml gl_4v3.zig GL_VERSION_4_3
//
...
// Loader API:
pub fn load(load_ctx: anytype, get_proc_address: fn (@TypeOf(load_ctx), [:0]const u8) ?FunctionPointer) LoadError!void {
    var success = true;
